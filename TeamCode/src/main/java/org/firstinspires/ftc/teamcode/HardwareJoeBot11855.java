...
public class HardwareJoeBot11855
{
    ...
    public static final double CLAMP_OPEN_POS = 0.1;
    public static final double CLAMP_CLOSE_POS = 0.7;
    public static final double CLAMP_DOWN_POS = 0.54;
    public static final double CLAMP_UP_POS = 0.2; //This position ".25" is for 1813 to fix the consistent flicking motion during "init" faz
    public static final double CLAMP_MID_POS = 0.53;
